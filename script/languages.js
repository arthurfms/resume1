const languages = {
  ...
  <section class="portfolio" id="portfolio">
    ...
    <div class="cards">
      <div class="card">
        <img class="card__image" src="./images/Around the U.S..png" />
        <div class="card__content">
          <a href="http://arthurfernandes.me/web_project_4/"
      ...
      <div class="card">
        <img class="card__image" src="./images/De Pátria para Pátria.png" />
        <div class="card__content">
          <a href="http://arthurfernandes.me/web_project_3_ptbr/"
      ...
      <div class="card">
        ...
        />
        <div class="card__content">
          <a href="http://arthurfernandes.me/web_project_1_ptbr/"
  ...
  <div class="header__container">
    ...
    <div class="header__content">
      ...
      <h2 class="header__subtitle">desarrollador frontend</h2>
      <ul class="list">
        <li class="list__item">
          <p>Nacionalidad:</p>
          <span>brazileño</span>
