...
setTimeout(function typeWriter() {
  if (i < text.length) {
    document.querySelector(".header__subtitle-text").innerHTML +=
      text.charAt(i);
    i++;
...
window.onload = function () {
  ...
  function DownloadFile() {
    //Download PDF
    var url =
      "https://arthurfms.github.io/arthur_fernandes/documents/CV%20-%20Arthur%20Fernandes.pdf";
  ...
  const slides = [
    ...
    },
    {
      title: "Data Analyst",
      subtitle:
        "Doctoralia Brasil (Curitiba - Brazil). March, 2021 / May, 2021",
      description: [
    ...
    },
    {
      ...
      subtitle:
        "Doctoralia Brasil (Curitiba - Brazil). September, 2019 / March, 2021",
      description: [
    ...
    },
    {
      ...
      subtitle:
        "Doctoralia Brasil (Curitiba - Brazil). April, 2019 / September, 2019",
      description: [
    ...
    },
    {
      ...
      subtitle:
        "SYKES Brasil (Curitiba - Brazil). September, 2018 / April, 2019",
      description: [
  ...
  if (!currentSlide) {
    ...
    startSlide.querySelector(".slide__subtitle").textContent =
      slides[0]["subtitle"];
    startSlide
      .querySelector(".slide__description")
      .querySelectorAll("p")[0].textContent = slides[0]["description"][0];
    startSlide
      .querySelector(".slide__description")
      .querySelectorAll("p")[1].textContent = slides[0]["description"][1];
  ...
  function nextSlide() {
    ...
    addSlide.querySelector(".slide__title").textContent =
      slides[newSlide]["title"];
    addSlide.querySelector(".slide__subtitle").textContent =
      slides[newSlide]["subtitle"];
    addSlide
      .querySelector(".slide__description")
      .querySelectorAll("p")[0].textContent =
      slides[newSlide]["description"][0];
    addSlide
      .querySelector(".slide__description")
      .querySelectorAll("p")[1].textContent =
      slides[newSlide]["description"][1];
    oldSlide.remove();
