window.onload = function () {
  ...
  document
    ...
    function genLink (name, email, subject, message) {
      var link =
      "https://docs.google.com/forms/d/e/1FAIpQLSeJfpSrGuskr7TRRpqjJZhvTV_XOQxIMLurwpSO71ejFwCbPw/formResponse?usp=pp_url&entry.1790382040=" + genEntry(name) + "&entry.1803059108=" + genEntry(email) + "&entry.992996464=" + genEntry(subject) + "&entry.1805953836=" + genEntry(message);
